...
🔗 https://github.com/semojaw/GraduationProjectsReview
...
- ANSYS Mechanical — *Intermediate*  
- ADAMS Car — *Beginner*  

### CAD
- Autodesk Inventor / AutoCAD — *Intermediate*
...
### Mathematics for Engineers Specialization (5 courses)  
**The Hong Kong University of Science and Technology — Coursera**
- Matrix Algebra for Engineers  
- Differential Equations for Engineers  
- Vector Calculus for Engineers  
- Numerical Methods for Engineers  
- Mathematics for Engineers: Capstone Course  
